...
namespace Infrastracture.Configurations.Identities
{
    public class CustomIdentityError : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric() { return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = "کلمه عبور باید حداقل یک علامت مانند (# و $ و @ و ! و ...) داشته باشد." }; }
